...
const SidebarProvider = React.forwardRef( //* new prop for default width
  (
    {
      defaultOpen = true,
      open: openProp,
...
const SidebarRail = React.forwardRef( //* new prop for enabling drag
  ({ className, enableDrag = true, ...props }, ref) => {
    ...
    const combinedRef = React.useMemo(() => mergeButtonRefs([ref, dragRef]), [
      ref,
      dragRef
    ])
